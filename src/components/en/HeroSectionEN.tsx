...
const ctaLinks = [
  { href: "/en/digital-collections", label: "Culture System", icon: Compass },
  { href: "/en/talent-cultivation", label: "Talent Development", icon: BookOpen },
  { href: "/en/research", label: "Industry Empowerment", icon: FlaskConical },
  { href: "/en/outcomes", label: "Digital Outcomes", icon: Users },
];
  ...
  return (
    <section className="relative min-h-[85vh] overflow-hidden bg-gradient-to-b from-bashu-teal/90 via-bashu-bronze/95 to-ink">
      ...
      <div className="relative mx-auto flex min-h-[85vh] max-w-6xl flex-col items-center justify-center px-4 py-24 text-center sm:px-6 lg:px-8">
        ...
        >
          A Panoramic Lens on Bashu Culture
          <br />
          <span className="text-brocade-gold-soft">Digital Heritage, Shared by All</span>
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
