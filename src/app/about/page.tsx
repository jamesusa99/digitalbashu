    ...
    <>
      ...
      <Section title="战略定位" subtitle="服务国家大后方，构建数字化新高地">
        <div className="mx-auto max-w-3xl space-y-6 text-muted">
          <p>
            巴蜀文化数字研究院是在四川省委宣传部、重庆市委宣传部的共同指导下成立，是深入贯彻
            <strong className="text-ink">「成渝地区双城经济圈」</strong>
            国家战略及
            <strong className="text-ink">「国家文化数字化战略」</strong>
            的核心载体。
          </p>
          <p>
            四川作为中国重要的战略腹地与民族复兴的坚实保障，研究院深知「四川不灭，华夏不亡」背后的文化韧性。我们立足于这一战略大省、人口大省，致力于通过前沿数字技术，将巴蜀这片英雄土地上的文化基因转化为
            <strong className="text-ink">新质生产力</strong>
            ，为西部地区的高质量发展提供持久的数字文化动力。
          </p>
        </div>
      </Section>
